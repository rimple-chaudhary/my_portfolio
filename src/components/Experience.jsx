	...
	const experiences = [
		{
			...
			description: "Collaborated on developing dynamic and responsive user interfaces, ensuring seamless user experiences across devices.",
		},
		{
			icon: Code2,
			...
			period: "2023 - Present",
			description: "Elevating JavaScript libraries and refining frameworks to enhance performance, scalability, and developer experience.",
		},
	];
